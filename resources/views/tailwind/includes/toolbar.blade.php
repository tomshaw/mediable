<div class="flex items-center justify-between h-full w-full px-4">
  ...
  <div class="flex items-center justify-end gap-1.5 xl:gap-2">
    ...
    <button wire:click="enableEditorMode()" class="group relative inline-flex h-7 items-center justify-center rounded-full overflow-hidden bg-[#555] px-4 text-xs font-normal text-white"><span>Editor</span>
