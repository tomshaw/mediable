    ...
    <div class="bg-gray-200 h-10 min-h-10 max-h-10 xl:h-11 xl:min-h-11 xl:max-h-11 2xl:h-12 2xl:min-h-12 2xl:max-h-12 w-full">
        <div class="flex items-center justify-between px-4 h-full w-full">
            <div>
                ...
                <button wire:click="enableEditorMode" class="group relative inline-flex h-7 items-center justify-center overflow-hidden rounded-full bg-[#555] px-4 text-xs font-normal text-white"><span>Launch Editor</span>
        ...
        <div class="flex items-start justify-center p-0 m-0 w-full h-full">
            <div class="flex flex-col items-start justify-start w-full p-2 gap-y-1.5">
                ...
                <figure class="w-full mb-0">
                    ...
                    <figcaption class="text-xs text-white overflow-hidden w-full select-none mt-2 py-1.5 px-2 bg-[#555] hover:bg-[#444]">{{$this->attachment->title}}</figcaption>
                </figure>
                @endif
