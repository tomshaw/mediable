    ...
    <div class="flex-grow border-b border-t border-[#ccc] h-full p-2">
        <div class="flex items-start justify-center p-0 m-0 w-full h-full overflow-hidden">
            <div class="flex flex-col items-start justify-start w-full gap-y-1.5 p-2">
                ...
                <figure class="mb-0">
                    <img src="{{ $this->attachment->file_url }}?id={{ $uniqueId }}" class="max-w-[227px] object-cover" />
                    <figcaption class="text-xs text-white overflow-hidden w-full max-w-[227px] select-none mt-2 py-1 px-2 bg-[#444] hover:bg-[#555]">{{$this->attachment->title}}</figcaption>
                </figure>
                @endif
                ...
                <figure class="mb-0">
                    ...
                    <figcaption class="text-xs text-white overflow-hidden w-full select-none mt-2 py-1 px-2 bg-[#444] hover:bg-[#555]">{{$this->attachment->title}}</figcaption>
                </figure>
                @endif 
