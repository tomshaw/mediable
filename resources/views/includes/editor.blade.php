...
<div class="relative flex items-center justify-center overflow-hidden p-4 md:p-6 lg:p-8 m-0 h-full bg-pattern">
    ...
    <div class="flex items-center justify-center">
        <img src="{{ asset($editorAttachment->file_url) }}?v={{ $this->cacheKey($editorAttachment->updated_at) }}.{{ $editorVersion }}" class="object-contain shadow-lg ring-1 ring-zinc-950/20 dark:ring-white/20 max-h-96">
    </div>
    @endif
</div>
