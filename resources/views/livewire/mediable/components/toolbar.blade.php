...
<div class="flex items-center justify-between h-full w-full px-4">
  ...
  <div class="flex items-center justify-start gap-1.5 xl:gap-2">
    ...
    <button wire:click="closeImageEditor" class="group relative inline-flex h-7 w-7 items-center justify-center overflow-hidden rounded-full bg-[#555] font-medium text-xs tracking-wider text-neutral-50 cursor-pointer transition active:scale-95">
      <x-icons.close />
    </button>
    @endif
  ...
  <div class="flex items-center justify-end gap-1.5 xl:gap-2">
    ...
    <button wire:click="clearFiles" class="group relative inline-flex items-center justify-center overflow-hidden rounded-full bg-[#555] py-1.5 px-4 font-medium text-xs tracking-wider text-neutral-50 cursor-pointer">
    ...
    <button wire:click="deleteAttachment" class="group relative inline-flex items-center justify-center overflow-hidden rounded-full bg-[#555] py-1.5 px-4 font-medium text-xs tracking-wider text-neutral-50 cursor-pointer">
      <span class="absolute h-0 w-0 rounded-full bg-red-500 transition-all duration-300 group-hover:h-56 group-hover:w-32"></span>
    ...
    <button wire:click="enableEditorMode()" class="group relative inline-flex h-7 items-center justify-center overflow-hidden rounded-full bg-[#555] px-4 font-medium text-xs tracking-wider text-neutral-50 cursor-pointer"><span>Editor</span>
    ...
    <button wire:click="enableUploadMode" class="group relative inline-flex h-7 items-center justify-center rounded-full bg-[#555] py-1.5 pl-5 pr-7 font-medium text-xs tracking-wider text-neutral-50 cursor-pointer"><span class="z-10 pr-2">Uploads</span>
